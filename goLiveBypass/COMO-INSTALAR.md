...
A versão atual do plugin é **2.0.6-beta-20**. Nesta linha, a VPN WireGuard/WireSock é
...
checkout do Equicord/Vencord. A release usa `2.0.6-beta-20`; a tag GitHub acrescenta
apenas o prefixo `v`.
